...
import static co.cvdcc.brojekcustomer.R.id.mSend_detail;
import static co.cvdcc.brojekcustomer.config.General.BOUNDS;
import static co.cvdcc.brojekcustomer.utils.Utility.round;
        ...
        try {
            ...
            if (routes.size() > 0) {
                directionLine = gMap.addPolyline((new PolylineOptions())
                        ...
                        .color(ContextCompat.getColor(SendActivity.this, R.color.directionLine))
                        .width(5));
